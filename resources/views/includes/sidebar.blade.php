                    ...
                    @if (Auth::check())
                        <a href="javascript:;" class="menu-profile-link" data-toggle="app-sidebar-profile"
                            ...
                            <div class="menu-profile-image menu-profile-image-icon bg-gray-900 text-gray-600">
                                @if (Auth::check())
                                    <img src="{{ Auth::user()->user_thumbnail }}" />
                                @else
        ...
        @php
            ...
            function renderSubMenu($value, $currentUrl)
            {
                ...
                foreach ($value as $key => $menu) {
                    ...
                    $hasCaret = !empty($menu['sub_menu'])
                        ? '
                                                            <div class="menu-caret"></div>
                                                            '
                        : '';
                    $hasHighlight = !empty($menu['highlight']) ? '<i class="fa fa-paper-plane text-primary ms-1"></i>' : '';
            ...
            foreach ($menuProvider as $key => $menu) {
                $GLOBALS['parent_active'] = '';
            
                $hasSub = !empty($menu['sub_menu']) ? 'has-sub' : '';
                $hasCaret = !empty($menu['caret'])
                    ? '
                                                            <div class="menu-caret"></div>
                                                            '
                    : '';
