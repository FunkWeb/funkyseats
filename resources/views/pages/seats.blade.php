    ...
    <div class='d-flex flex-wrap justify-content-around mt-30px'>
        @foreach ($seats as $seat)
            <div class='text-center text-light text-uppercase mt-30px'
                style="width: 224px; height: 160px; background-image: url({{ asset('images/table.png') }}); background-size: cover; cursor: pointer; border-radius: 5%; border: none ">
                <div
                    style='width: 224px; height: 160px; background-image: -webkit-linear-gradient(top, rgb(31 25 61 / 70%), rgba(217 134 10 / 40%))'>
                    <div style='font-size:16px; padding-top: 68px'>{{ $seat->type }}</div>
                </div>
            </div>
        @endforeach
    </div>
