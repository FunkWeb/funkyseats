...
@section('content')
	...
	<!-- end breadcrumb -->
	<!-- begin page-header -->
	<h4 class="fw-600 text-center">Choose a seat <!-- <small>header small text goes here...</small> --></h4>
	<!-- end page-header -->
...
@for ($i = 0; $i < 10; $i++)
    <div class='text-center text-light text-uppercase mt-30px' style="width: 224px; height: 160px; background-image: url({{ asset('images/table.png') }}); background-size: cover; cursor: pointer; border-radius: 5%; border: none ">
        <div  style='width: 224px; height: 160px; background-image: -webkit-linear-gradient(top, rgb(31 25 61 / 70%), rgba(217 134 10 / 40%))'>
        <div style='font-size:16px; padding-top: 68px'>{{$i +1}}</div>
        </div>
    </div>
@endfor
</div>
